...
def listener():
    ...
    trophy.pose.position.x = trophy_array[0] + 0.10
    trophy.pose.position.y = trophy_array[1] + 0.06
    trophy.pose.position.z = trophy_array[2] + 0.05

    ball_array = np.array([ball.pose.position.x, ball.pose.position.y, ball.pose.position.z])
    ball_array = np.dot(np.transpose(R_m2b), ball_array-T_m2b)
    ball.pose.position.x = ball_array[0] + 0.25
    ball.pose.position.y = ball_array[1] + 0.06
    ball.pose.position.z = ball_array[2] + 0.05
    ...
    cup.pose.position.x = cup_array[0] + 0.2
    cup.pose.position.y = cup_array[1] +0.10
    ...
    middle_shelf.pose.position.x = middle_shelf_array[0]+ 0.18
    middle_shelf.pose.position.y = middle_shelf_array[1] + 0.20
    middle_shelf.pose.position.z = middle_shelf_array[2] +0.1
    ...
    bottom_shelf.pose.position.x = bottom_shelf_array[0] + 0.1
    bottom_shelf.pose.position.y = bottom_shelf_array[1] +0.20
    bottom_shelf.pose.position.z = bottom_shelf_array[2] + 0.1
