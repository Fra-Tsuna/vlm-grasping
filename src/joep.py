...
def GraspCallback(obj): 
    ...
    try:
        trans_base = tf_buffer.lookup_transform("xtion_rgb_optical_frame", "base_footprint",  rospy.Time(0), rospy.Duration(1.0))
        trans_arm = tf_buffer.lookup_transform("xtion_rgb_optical_frame", "arm_1_link",  rospy.Time(0), rospy.Duration(1.0))
    except:
